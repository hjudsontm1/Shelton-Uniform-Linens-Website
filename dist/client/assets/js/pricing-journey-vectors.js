(function () {
  ...
  const backdropFor = (operationId) => {
    const backdrops = {
      ...
      medspa: `<path class="scene-structure" d="M58 285 H842 M650 208 q68-72 136 0 v77 H650 Z" /><path class="scene-accent" d="M675 197 q43-42 86 0" /><text class="scene-note" x="656" y="179">TREATMENT-ROOM FLOW</text>`,
