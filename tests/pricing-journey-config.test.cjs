...
assert.match(production, /pricing-spine-concept\.css\?v=20260803-estimator-v24/);
assert.match(production, /pricing-calm\.css\?v=20260802-volume-entry-v17/);
assert.match(production, /pricing-learning\.js\?v=20260803-estimator-v24/);
assert.match(production, /pricing-journey-config\.js\?v=20260803-estimator-v24/);
assert.match(production, /pricing-engine\.js\?v=20260803-estimator-v24/);
assert.match(production, /pricing-progressive-range\.js\?v=20260803-estimator-v24/);
assert.match(production, /aria-label="Six estimator steps"/);
